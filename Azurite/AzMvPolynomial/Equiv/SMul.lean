...
theorem filterMap_smul_sum (r : R) (l : List (Monomial n R ord)) :
...
@[simp] theorem toMvPoly_smul (r : R) (p : AzMvPolynomial n R ord) :
...
@[simp] theorem ofMvPoly_smul (r : R) (p : MvPolynomial (Fin n) R) :
    (AzMvPolynomial.ofMvPoly (r • p) : AzMvPolynomial n R ord) =
