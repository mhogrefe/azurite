...
#guard (parseAzPolynomial (R := ℤ) "3*x^2+2*x+1").get!.evalSpecial 5 2 == 99

-- c = 1 recovers ordinary eval
#guard (parseAzPolynomial (R := ℤ) "3*x^4-x^2+1").get!.evalSpecial 2 1 == 45

-- P = x^2 + 1, b = 3, c = 2: c^2(9/4 + 1) = 13
#guard (parseAzPolynomial (R := ℤ) "x^2+1").get!.evalSpecial 3 2 == 13

-- c = 0 gives a_p * b^p
-- P = 2x^2 + x + 3, b = 5, c = 0: 2·25 = 50
#guard (parseAzPolynomial (R := ℤ) "2*x^2+x+3").get!.evalSpecial 5 0 == 50
